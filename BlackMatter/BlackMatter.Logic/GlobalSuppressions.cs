...
[assembly: SuppressMessage("Security", "CA5394:Do not use insecure randomness", Justification = "<Pending>", Scope = "member", Target = "~M:BlackMatter.Logic.GameLogic.EnemyPlacer~System.Collections.Generic.List{BlackMatter.Model.Enemy}")]
[assembly: SuppressMessage("Security", "CA5394:Do not use insecure randomness", Justification = "<Pending>", Scope = "member", Target = "~M:BlackMatter.Logic.GameLogic.EnemyMove")]
